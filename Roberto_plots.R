...
######### Frequency
ggplot() +
    geom_freqpoly(data = reverse,aes(X3,size = 'qsec'),binwidth = 5,col="red")+ geom_freqpoly(data = positive,aes(X3,size = 'qsec'),binwidth = 5,col="black") +theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
